...
require(['jquery'], function($) {
    ...
    var taskTemplate = '<li class="task"><input class="complete" type="checkbox" /><input type="text" class="description" placeholder="Enter description here..." /><button class="delete-button">Delete</button></li>';
    ...
    function registerEvenetHandlers() {
